...
| Image build, UI typecheck/build, in-image unit tests | `docker compose build` | **Failed** in the first server run (the `tee` bug above); the rest of the build was cancelled. Re-run pending |
